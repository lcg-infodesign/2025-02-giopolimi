...
function setup() {
  ...
  let cols = floor((windowWidth - outerPadding * 2) / (itemSize + padding)); //floor --> arrotonda per difetto
  ...
  for(let rowNumber = 0; rowNumber < table.getRowCount(); rowNumber++) { //++ --> aumenta di 1
